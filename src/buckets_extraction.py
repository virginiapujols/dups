...
def predict_bucket(classifier, new_bug_report, bucket):
    """
...
def propose_candidate(classifier, new_bug_report, buckets, n_top = 0):
    """
    ...
    for master in buckets:
        ...
        similarity = predict_bucket(classifier, new_bug_report, bucket)
